...
WIDTH, HEIGHT, MARGIN, FRAMES = 2048, 1056, 128, 1
FONT_PATH = "fonts/ttf/KambujaAksara13x14-Regular.ttf"
FONT_LICENSE = "OFL v1.1"
AUXILIARY_FONT = "Helvetica"
AUXILIARY_FONT_SIZE = 48

LINE_ONE = "កម្ពុជអក្សរ /kambuja aksara/ ព.ស. ១៣ - ១៤"
LINE_TWO = "កខគឃងចឆជឈញដឋឌឍណតថទធនបផពភមយរលវឝឞសហឡអ"
LINE_THREE = "អឤឥឦអឹអឺឧឩអួអើអឿអៀឯអែឰឱឳឪឲឨឫឬឭឮ"
LINE_FOUR = "ា ិ ី ឹ ឺ ុ ូ ួ ើ ឿ ៀ េ ែ ៃ ោ ៅ ុំ ំ ាំ"
LINE_FIVE = "ះ ុះ េះ ោះ  ៉ ៊ ៍ ៌ ់ ័ ៗ ៏ ៎ ៙ ។ ៕ ៚ ៘ ៈ ៑ "
LINE_SIX = "្ក ្ខ ្គ ្ឃ ្ង ្ច ្ឆ ្ជ ្ឈ ្ញ ្ដ ្ឋ ្ឌ ្ឍ ្ណ ្ត ្ថ ្ទ ្ធ ្ន"
LINE_SEVEN = "្ប ្ផ ្ព ្ភ ្ម ្យ ្រ ្ល ្វ ្ឝ ្ឞ ្ស ្ហ ្ឡ ្អ"
LINE_EIGHT = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"
LINE_NINE = "0123456789-០១២៣៤៥៦៧៨៩"

BIG_TEXT_FONT_SIZE = 56
BIG_TEXT_SIDE_MARGIN = MARGIN * 1
BIG_TEXT_BOTTOM_MARGIN = MARGIN * 6.7
...
def draw_divider_lines():
    ...
    strokeWidth(5)
    lineCap("round")
    line((MARGIN, HEIGHT - (MARGIN * 1)), (WIDTH - MARGIN, HEIGHT - (MARGIN * 1)))
...
def draw_auxiliary_text():
    ...
    POS_TOP_LEFT = (MARGIN, HEIGHT - MARGIN * 0.75)
    POS_TOP_RIGHT = (WIDTH - MARGIN, HEIGHT - MARGIN * 0.75)
